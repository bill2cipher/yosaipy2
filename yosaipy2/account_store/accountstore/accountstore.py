...
from yosaipy2.account_store import (
    init_session
)

from yosaipy2.account_store.models.models import (
    Credential,
    CredentialType,
    User,
    Domain,
    ...
    def _get_permissions_query(self, session, identifier):
        ...
        stmt1 = (
            session.query(
                ...
                action_agg.label('action')).select_from(User).
        ...
        stmt3 = (session.query(stmt2.c.domain,
                               func.row_to_json(AsRow(stmt2)).label('parts')).
