...
class MsgpackSerializer(serialize_abcs.CustomizableSerializer):
    ...
    * ``encoding='utf-8'`` (unpacker)
    ...
    : Dict[str, Any] = None, custom_type_code: int = 119):
...
def register_custom_type(
        self, cls: type, marshaller

: Optional[Callable[[Any], Any]] = default_marshaller,
...
def _custom_object_hook(self, code: int, data
